...
for i = 1:4
    for j = 1:8
        matrix_vals(5-i,j) = fitness_matrix_J_saved(i,j);
    end
end    
...
for i = 1:4
    for j = 1:8
        matrix_vals(5-i,j) = fitness_matrix_r0_saved(i,j);
    end
end    
...
figure;
title('Fraction of L','Interpreter','latex')
set(gca,'FontSize',20);

figure;
title('$\mathrm{Growth~Rate~[h^{-1}]}$','Interpreter','latex')
set(gca,'FontSize',20);


figure;
title('$\mathrm{Birth~States~(E+L)~[ml^{-1}]}$','Interpreter','latex')
set(gca,'FontSize',20);
...
plot(1,1)
xlabel('Time [Hours]','Interpreter','latex')
ylabel('$\mathrm{Resource~Concentration~[\mu g/ml]}$','Interpreter','latex')
